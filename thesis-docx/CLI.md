...
python cli.py set-format --by-text "标题" --style h1 "论文.docx"  # 手动设样式
python cli.py set-format --target headings --style h1 "论文.docx"
...
python cli.py renumber-figures "论文.docx"
```
...
| `--after-text "子串"` | insert-paragraph / insert-image / insert-table / insert-page-break | 在匹配段落后插入 |
